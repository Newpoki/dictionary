    ...
    ({ className, endAdornment, error, type, ...props }, ref) => {
        ...
        return (
            <div className="flex flex-col gap-2 text-[16px] font-bold leading-[17px] md:text-h-s">
                <label
                    className={cn(
                        'flex w-full items-center gap-4 rounded-2xl bg-grey-100 px-6 pb-[15px] pt-4 transition-colors focus-within:ring-1 focus-within:ring-purple-500 focus-visible:outline-none has-[:disabled]:cursor-not-allowed has-[:disabled]:opacity-50 dark:bg-grey-800 dark:focus-within:ring-purple-500 md:py-5',
                        {
